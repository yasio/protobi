/////////////////////////////////////////////////////////////
// cross platform socket APIs, support ios & android & wp8
/////////////////////////////////////////////////////////////
#ifndef _XXSOCKET_H_
#define _XXSOCKET_H_
#ifdef _WIN32
...
#define IS_RCV_SHOULD_CLOSE(n, errcode) \
    ( ((n) == 0) \
    || ((n) < 0 \
        && (errcode) != EAGAIN \
        && (errcode) != EINTR) ) 
...
#define IS_SND_SHOULD_CLOSE(n, errcode) \
    ( ((n) == 0) \
    || ((n) < 0 \
       && (errcode) != EAGAIN \
       && (errcode) != EWOULDBLOCK \
...
static
timeval make_timeval(uint32_t sec, uint32_t usec = 0)
{
    timeval tv;
    tv.tv_sec = sec;
    tv.tv_usec = usec;
...
public:
    ...
    */
    ...
    {
        return connect_n(s, addr, port, timeout);
    }
    static int connect_n(socket_native_type s,const char* addr, u_short port, timeval& timeout);
